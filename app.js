const creators = [
  {name:'Yoga With Adriene', handle:'@yogawithadriene', niche:'Yoga & mindful movement', subs:'13.7M', views:'10.6M', eng:'4.8%', score:96, image:'https://i.ytimg.com/vi/OMu6OKF5Z1k/maxresdefault.jpg', videoImage:'https://i.ytimg.com/vi/k2oe-PAHTR0/maxresdefault.jpg', tags:['All levels','High trust'], prompt:'Channel signal', signal:'Gentle, accessible guidance turns a daily wellness habit into a welcoming community ritual.', videoTitle:'Yoga Morning Fresh · 35-minute practice', risk:'Established wellness partnerships · Review category exclusivity', why:'Adriene’s inclusive teaching style and broad wellness audience align strongly with an approachable hydration campaign. Her long-form routines also create natural product-use moments.'},
  {name:'Jeff Nippard', handle:'@JeffNippard', niche:'Evidence-based fitness', subs:'3M+', views:'4.1M', eng:'5.9%', score:93, image:'https://i.ytimg.com/vi/nxisr1AalNc/maxresdefault.jpg', videoImage:'https://i.ytimg.com/vi/k1Xr8rMK-Gw/maxresdefault.jpg', tags:['Science-led','High intent'], prompt:'Channel signal', signal:'Research becomes practical training advice with clear visuals, tests, and specific takeaways.', videoTitle:'The most effective full-body workout for growth', risk:'High sponsor demand · Strong evidence-led brand fit', why:'Jeff’s audience actively seeks performance science and product evidence. The fit is strongest when messaging includes transparent ingredients and avoids broad wellness claims.'},
  {name:'The Running Channel', handle:'@runningchannel', niche:'Running education', subs:'833K', views:'1.1M', eng:'5.2%', score:91, image:'https://i.ytimg.com/vi/zX_TbrKjESU/maxresdefault.jpg', videoImage:'https://i.ytimg.com/vi/zX_TbrKjESU/maxresdefault.jpg', tags:['Endurance','Community'], prompt:'Channel signal', signal:'Beginner-friendly coaching answers practical questions before, during, and after a run.', videoTitle:'How to run longer without getting tired', risk:'Existing fitness partners · Direct endurance relevance', why:'The channel’s audience is already thinking about endurance, warm-ups, breathing, and nutrition. That creates a direct education path for hydration without forcing the integration.'},
  {name:'Hybrid Calisthenics', handle:'@HybridCalisthenics', niche:'Accessible strength', subs:'4.47M', views:'1.2M', eng:'6.4%', score:89, image:'https://i.ytimg.com/vi/z3XQ7T4-abQ/maxresdefault.jpg', videoImage:'https://i.ytimg.com/vi/RYLw1cMYHX0/maxresdefault.jpg', tags:['Beginner-first','Positive'], prompt:'Channel signal', signal:'Every movement starts with something the viewer can do today, then builds from there.', videoTitle:'You CAN do deep squats, my friend', risk:'Low sponsor density · Strong community sentiment', why:'Hampton’s encouraging, progression-based format matches a product story built around consistency rather than extremes. Audience trust is the primary value.'},
  {name:'Pick Up Limes', handle:'@PickUpLimes', niche:'Plant-based wellness', subs:'4.37M', views:'1.1M', eng:'5.7%', score:87, image:'https://i.ytimg.com/vi/yQmo3Z_xSlM/maxresdefault.jpg', videoImage:'https://i.ytimg.com/vi/xNzZqVUl28E/maxresdefault.jpg', tags:['Nutrition','Cinematic'], prompt:'Channel signal', signal:'Calm, beautifully produced food stories make nutrition feel useful rather than prescriptive.', videoTitle:'Simple plant-based habits for everyday energy', risk:'Premium production bar · Strong clean-label fit', why:'The channel pairs nutrition credibility with polished storytelling. NovaFuel fits best as part of a broader routine instead of a direct-response product demonstration.'},
  {name:'Chloe Ting', handle:'@ChloeTing', niche:'Home fitness', subs:'26.1M', views:'1.28M', eng:'4.4%', score:85, image:'https://i.ytimg.com/vi/4I-dymlpGOQ/maxresdefault.jpg', videoImage:'https://i.ytimg.com/vi/4I-dymlpGOQ/maxresdefault.jpg', tags:['Global reach','Workout series'], prompt:'Channel signal', signal:'Structured challenges give a global audience an easy reason to return and participate together.', videoTitle:'20-minute full-body HIIT · no jumping', risk:'High campaign volume · Excellent global scale', why:'Chloe offers exceptional reach and repeat participation. Campaign creative should prioritize a simple routine moment and localized claims for an international audience.'},
  {name:'Blogilates', handle:'@blogilates', niche:'Pilates & lifestyle', subs:'11M', views:'572K', eng:'4.9%', score:82, image:'https://i.ytimg.com/vi/86PciGuG7Sk/maxresdefault.jpg', videoImage:'https://i.ytimg.com/vi/86PciGuG7Sk/maxresdefault.jpg', tags:['Pilates','Founder-led'], prompt:'Channel signal', signal:'Energetic classes, product-building stories, and a recognizable host-led format drive loyalty.', videoTitle:'25-minute complete leg workout', risk:'Founder-owned product ecosystem · Check conflicts', why:'Cassey’s founder-led audience responds to energy and participation. Brand fit is promising, though product-category conflicts should be reviewed before outreach.'}
];
